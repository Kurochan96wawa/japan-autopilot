...
def _build_redirects() -> int:
    ...
    lines = [
        ...
        "",
        "# --- www → apex（2026-09-21） -------------------------------------------",
        "# !! この2行は現時点では発火しない。www.littletabi.com は Cloudflare Pages に",
        "#    紐づいておらず、DNSが kurochan96wawa.github.io（GitHub Pages・無効）を",
        "#    向いているため。GSCは7月から www を404として記録している。",
        "#    直し方: Cloudflare DNS の www レコードを apex 向き(proxied)に変更するか、",
        "#    www.littletabi.com を Pages プロジェクトのカスタムドメインに追加する。",
        "#    その作業をした瞬間にこの2行が効くよう、先に置いておく（順序を逆にすると",
        "#    wwwが200を返す重複コンテンツ期間ができてしまう）。",
        "https://www.littletabi.com/*  https://littletabi.com/:splat  301!",
        "http://www.littletabi.com/*   https://littletabi.com/:splat  301!",
        "",
    ]
